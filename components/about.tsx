...
function About() {
  return (
    <section className="w-full flex bg-gradient-to-b from-[#171738] via-[#726C00]/80 to-[#3423A6]">
      <div className="w-[60%] my-[5%] rounded-tr-xl rounded-br-xl relative flex justify-center items-center">
      ...
      <div className=" w-[40%] flex justify-center items-center ">
        <div className="flex flex-col gap-10 text-center w-full items-center relative top-[5%]">
          <h1 className="w-[85%] text-4xl text-[#F1C900] text-left font-cheapSignage font-medium">
            ...
            participants with the necessary skills, knowledge, and confidence to{" "}
            <span className="text-white italic">succeed</span> in their chosen
            career paths, <span className="text-white italic">together.</span>
          </h1>
